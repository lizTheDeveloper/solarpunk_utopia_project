...
src/crypto/keys.ts:110:function xorEncrypt(plaintext: Uint8Array, key: Uint8Array): Uint8Array {
src/crypto/keys.ts:133:  // Temporary XOR encryption - TODO: Replace with XChaCha20-Poly1305
src/crypto/keys.ts:134:  const ciphertext = xorEncrypt(privateKey, key);
src/crypto/keys.ts:160:  // Temporary XOR decryption - TODO: Replace with XChaCha20-Poly1305
src/crypto/keys.ts:161:  const privateKey = xorEncrypt(ciphertext, key);
```
